...
test.describe('Unassigned', () => {
  ...
  "UniqueRuleNameSearch": "TsSearchUniqueRuleName"
    ...
    await correspondentPortalPage.Chase_Value.selectOption({ label: testData["Chase Value"] });
    await correspondentPortalPage.Bid_Tape_Value.fill(testData["Bid Tape Value"]);
