...
test.describe('REG_Bid Maps', () => {
  ...
  "UniqueRuleNameSearch": "TsSearchUniqueRuleName"
    ...
    await correspondentPortalPage.Search_Text_Field.fill(Array.from({length: 5}, () => "abc".charAt(Math.floor(Math.random() * 3))).join(''));
    ...
    await correspondentPortalPage.Search_Text_Field.fill(testData["BidFields"]);
