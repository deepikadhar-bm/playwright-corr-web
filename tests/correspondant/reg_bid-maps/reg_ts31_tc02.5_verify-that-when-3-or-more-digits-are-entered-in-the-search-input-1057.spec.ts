...
test.describe('REG_Bid Maps', () => {
  ...
  let REG_TS31_TC02_3_5testFailed=false;
  ...
  test(`${TC_ID} - ${TC_TITLE}`, async ({ page }) => {
    ...
    try {
      ...
      REG_TS31_TC02_3_5testFailed=true;
      log.tcEnd('FAIL');
      throw e;
    }
  });
   test.afterEach(async ({ page }) => {
    log.afterTestSteps(TC_ID, REG_TS31_TC02_3_5testFailed);
    if (REG_TS31_TC02_3_5testFailed) {
      try {
