  ...
  test(`${TC_ID} - ${TC_TITLE}`, async ({ page }) => {
    ...
    try {
      ...
      try {
        ...
        Methods.addMinutesToDatetime(vars['CurrentEstTime'], appconstants.TIME_FORMAT_HHMMA, 1, appconstants.TIME_FORMAT_HHMMA, 'CurrentEstTimePlusOneMin');
        Methods.subtractMinutesFromDatetime(vars['CurrentEstTime'], appconstants.TIME_FORMAT_HHMMA, 1, appconstants.TIME_FORMAT_HHMMA, 'CurrentEstTimeMinusOneMin');
      ...
      try {
        const loanDetailsProfileName = 'Loan Level Details';
      ...
      try {
        ...
        Methods.concatenateWithSpace(vars['ExpectedFileName'], vars['CurrentEstTime'], 'ExpectedFileName');
