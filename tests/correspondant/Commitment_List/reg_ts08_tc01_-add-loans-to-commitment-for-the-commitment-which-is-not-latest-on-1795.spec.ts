...
const TC_TITLE = 'Add loans to commitment for the commitment which is not latest one and verify auth limit values';
  ...
  test(`${TC_ID} - ${TC_TITLE}`, async ({ page }) => {
    ...
    try {
      ...
      try {
        ...
        log.stepPass('Successfully Login to Correspondent Portal');
      } catch (e) {
        await log.stepFail(page, 'Failed to login ');
        throw e;
      }
      ...
      try {
        ...
        log.info('Expected Last Committed Bid Date and Time: ' + vars['ExpectedLastCommittedBidDateAndTime']);
      ...
      try {
        ...
        await log.stepFail(page, 'Failed to verify the Auth limit values after perform add to commit action');
        throw e;
      }
      ...
      try {
        ...
        log.stepPass('Successfully verified Last committed bid date and time, Last committed loan amount');
      } catch (e) {
        await log.stepFail(page, 'Failed to verify Last committed bid date and time, Last committed loan amount');
        throw e;
      }
