...
import { runPrereq_1913 } from '@helpers/prereqs/Commitment_List-Pre-requites/prereq-1913';
import { Logger as log } from '@helpers/log-helper';
import { AddonHelpers } from '@helpers/AddonHelpers';
import { testDataManager } from 'testdata/TestDataManager';
import { APP_CONSTANTS as appconstants } from '../../../src/constants/app-constants';

const TC_ID = 'REG_TS14_TC02.1';
...
test.describe('Commitment List - TS_14', () => {
  ...
  test(`${TC_ID} - ${TC_TITLE}`, async ({ page }) => {
    ...
    try {
      ...
      try {
        vars['LoanNumberExcel'] = excelHelper.readCellByColAndRowIndex(vars['FilePath'], 0, 2, 3);
