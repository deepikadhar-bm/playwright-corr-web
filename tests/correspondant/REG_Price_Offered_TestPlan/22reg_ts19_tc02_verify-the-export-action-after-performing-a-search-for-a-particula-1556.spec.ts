        ...
        while (parseFloat(String(vars['RowCountUI'])) <= parseFloat(String(vars['RowCount']))) {
          ...
          while (parseFloat(String(vars['ColumnCountUI'])) <= parseFloat(String('9'))) {
            ...
            if (String(vars['IndividualCellValueExcel']).includes(appconstants.ET)) {
              Methods.removeCharactersFromPosition(vars['IndividualCellValueExcel'], '0', '2', 'IndividualCellValueExcel');
              Methods.trimtestdata(vars['IndividualCellValueExcel'], 'IndividualCellValueExcel');
              Methods.convertDateTimeZone(vars['IndividualCellValueExcel'], appconstants.DATE_TIME_FORMAT_EXCEL_EST, appconstants.AMERICA_NEW_YORK, appconstants.DATE_FORMAT_MMDDYYYY, appconstants.UTC, "IndividualCellValueExcel");
