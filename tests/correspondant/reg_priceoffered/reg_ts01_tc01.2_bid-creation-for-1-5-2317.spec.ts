...
import { runPrereq_2318 } from '../../../src/helpers/prereqs/prereq-2318';
    ...
    try {
      ...
      try {
        ...
        await correspondentPortalPage.Upload_File.setInputFiles([
          path.resolve(__dirname, '../../../uploads', fileconstants.NEW_FILE_LOAN_POPUP_VERIFICATION)
        ]);
