...
const TC_ID = 'REG_TS01_TC01.1';
const TC_TITLE = 'Updating the Loan Numbers (1-5 and 2-5)';
...
test.describe('Unassigned', () => {
  ...
  test(`${TC_ID} - ${TC_TITLE}`, async ({ page }) => {
    ...
    try {
      ...
      try {
        const filePath = path.resolve(__dirname, '../../../uploads', fileconstants.NEW_FILE_LOAN_POPUP_VERIFICATION);
