...
test.describe('Commitment List - TS_1', () => {
  ...
  test('REG_TS17_TC01_Perform download action for PQ file and verify the details', async ({ page }) => {
    ...
    log.info("Expected File Name:"+vars['ExpectedFileName1'])
    ...
    log.info("PQ File was downloaded successfully")
    ...
    log.info("PS File2 was downloaded successfully")
    ...
    log.info("Successfully completed testcase-TS17_TC01")
  });
});
});