export const APP_CONSTANTS = {
  ...
  COMMITMENT_IN_PROGRESS_STATUS1: "Commitment in Progress",
  ADD_TO_COMMIT_TEXT:'Add to Commit',
  DATE_FORMATEYYYYMMDD: "yyyy/MM/dd",
  ...
  StandardExecutionTableHeader: "Standard",
  ...
  CompanyNameConfig: "Chase",
  ExecutionTypeHeaderStandard: "Standard",
  ExecutionTypeHeaderChaseDirect: "Chase Direct",
