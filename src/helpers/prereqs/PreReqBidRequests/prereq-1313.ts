...
export async function runPrereq_1313(page: Page, vars: Record<string, string>): Promise<void> {
...
const TC_ID = 'PREQ-1313';
const TC_TITLE = 'Prerequisite for REG_TS30_TC01';
