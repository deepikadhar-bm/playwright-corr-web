...
const TC_ID = 'PREREQ-911';
const TC_TITLE = 'Prerequisite for 32-1 : Create Bid Maps with rules and actions for advance search functionality';
  ...
  log.tcStart(TC_ID, TC_TITLE);
      ...
      try {
        ...
        try {
          ...
          vars["RuleBidTapeValue1"] = APP_CONSTANTS.BidEnumeratedTapeValue1;
          //await stepGroups.stepGroup_Adding_Actions_In_Rules_and_Actions_Screen(page, vars);
        ...
        try {
          ...
          vars["RuleBidTapeValue2"] = APP_CONSTANTS.BidEnumeratedTapeValue2;
          // await stepGroups.stepGroup_Adding_Actions_In_Rules_and_Actions_Screen(page, vars);
          // const CorrPortalElem = new CorrPortalPage(page);
          const Methods = new AddonHelpers(page, vars);
        ...
        try {
          ...
          vars["RuleBidTapeValue3"] = APP_CONSTANTS.BidEnumeratedTapeValue3;
          //await stepGroups.stepGroup_Adding_Actions_In_Rules_and_Actions_Screen(page, vars);
          //const CorrPortalElem = new CorrPortalPage(page);
          const Methods = new AddonHelpers(page, vars);
...
//After Steps if test failed then delete the created bid maps in the cleanup else do nothing
