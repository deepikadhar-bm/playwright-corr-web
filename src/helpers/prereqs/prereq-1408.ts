...
import { runPrereq_1290 } from './prereq-1290';

export async function runPrereq_1408(page: Page, vars: Record<string, string>): Promise<void> {
  await runPrereq_1290(page, vars);
