...
// import { runPrereq_1909 } from './prereq-1909';
...
const TC_ID = 'PREREQ_1913(REG_TS14_TC02)';
...
export async function runPrereq_1913(page: Page, vars: Record<string, string>): Promise<void> {
