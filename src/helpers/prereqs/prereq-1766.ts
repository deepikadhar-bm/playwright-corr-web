...
export async function runPrereq_1766(page: Page, vars: Record<string, string>): Promise<void> {
  ...
  log.step('Prereq TS05_TC04: Navigate to Price Offered list and commit a loan for Company A');
  ...
  log.info('Prereq TS05_TC04 completed successfully. BidReqIdCompanyA: ' + vars['BidReqIdCompanyA'] + ' | BidReqIdCompanyB: ' + vars['BidReqIdCompanyB']);
}