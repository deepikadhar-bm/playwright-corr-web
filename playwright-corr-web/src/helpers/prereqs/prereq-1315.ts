...
import { runPrereq_1410 } from './prereq-1410';

export async function runPrereq_1315(page: Page, vars: Record<string, string>): Promise<void> {
  await runPrereq_1410(page, vars);
